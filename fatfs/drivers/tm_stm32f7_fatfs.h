...
extern FATFS fatfs_fs;      /* FatFs file system object */
extern FIL fs_file;              /* File object */
//extern FRESULT fs_res;           /* File operation result */
extern UINT fs_fnum;             /* Number of files successfully read and written */
extern BYTE fs_readbuffer[4096];        /* Read buffer */
extern BYTE fs_writebuffer[128];       /* Write buffer*/
/**
 * @}
 */
