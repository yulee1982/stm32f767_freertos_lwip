...
#define FF_USE_STRFUNC	0  //�����ַ�������,���ǲ�����LF-CRLFת���ġ�
...
#define FF_USE_LFN		1 //1 use 1 must set FF_FS_REENTRANT=0
...
#define FF_VOLUMES		8 //3
/* Number of volumes (logical drives) to be used. (1-10) */

#define FF_STR_VOLUME_ID	1  // 1: Can convert the raw disk drive letter string into a drive bay number; 2: Can use '/' as a path separator
