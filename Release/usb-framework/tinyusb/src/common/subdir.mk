...
C_SRCS += \
../usb-framework/tinyusb/src/common/tusb_fifo.c 

OBJS += \
./usb-framework/tinyusb/src/common/tusb_fifo.o 

C_DEPS += \
./usb-framework/tinyusb/src/common/tusb_fifo.d 


# Each subdirectory must supply rules for building sources it contributes
usb-framework/tinyusb/src/common/%.o usb-framework/tinyusb/src/common/%.su usb-framework/tinyusb/src/common/%.cyclo: ../usb-framework/tinyusb/src/common/%.c usb-framework/tinyusb/src/common/subdir.mk
...
clean: clean-usb-2d-framework-2f-tinyusb-2f-src-2f-common

clean-usb-2d-framework-2f-tinyusb-2f-src-2f-common:
	-$(RM) ./usb-framework/tinyusb/src/common/tusb_fifo.cyclo ./usb-framework/tinyusb/src/common/tusb_fifo.d ./usb-framework/tinyusb/src/common/tusb_fifo.o ./usb-framework/tinyusb/src/common/tusb_fifo.su

.PHONY: clean-usb-2d-framework-2f-tinyusb-2f-src-2f-common
