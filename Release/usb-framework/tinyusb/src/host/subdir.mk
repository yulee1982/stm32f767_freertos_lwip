...
C_SRCS += \
../usb-framework/tinyusb/src/host/hub.c \
../usb-framework/tinyusb/src/host/usbh.c 

OBJS += \
./usb-framework/tinyusb/src/host/hub.o \
./usb-framework/tinyusb/src/host/usbh.o 

C_DEPS += \
./usb-framework/tinyusb/src/host/hub.d \
./usb-framework/tinyusb/src/host/usbh.d 


# Each subdirectory must supply rules for building sources it contributes
usb-framework/tinyusb/src/host/%.o usb-framework/tinyusb/src/host/%.su usb-framework/tinyusb/src/host/%.cyclo: ../usb-framework/tinyusb/src/host/%.c usb-framework/tinyusb/src/host/subdir.mk
...
clean: clean-usb-2d-framework-2f-tinyusb-2f-src-2f-host

clean-usb-2d-framework-2f-tinyusb-2f-src-2f-host:
	-$(RM) ./usb-framework/tinyusb/src/host/hub.cyclo ./usb-framework/tinyusb/src/host/hub.d ./usb-framework/tinyusb/src/host/hub.o ./usb-framework/tinyusb/src/host/hub.su ./usb-framework/tinyusb/src/host/usbh.cyclo ./usb-framework/tinyusb/src/host/usbh.d ./usb-framework/tinyusb/src/host/usbh.o ./usb-framework/tinyusb/src/host/usbh.su

.PHONY: clean-usb-2d-framework-2f-tinyusb-2f-src-2f-host
