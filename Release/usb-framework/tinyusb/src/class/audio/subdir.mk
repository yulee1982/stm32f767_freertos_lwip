...
C_SRCS += \
../usb-framework/tinyusb/src/class/audio/audio_device.c 

OBJS += \
./usb-framework/tinyusb/src/class/audio/audio_device.o 

C_DEPS += \
./usb-framework/tinyusb/src/class/audio/audio_device.d 


# Each subdirectory must supply rules for building sources it contributes
usb-framework/tinyusb/src/class/audio/%.o usb-framework/tinyusb/src/class/audio/%.su usb-framework/tinyusb/src/class/audio/%.cyclo: ../usb-framework/tinyusb/src/class/audio/%.c usb-framework/tinyusb/src/class/audio/subdir.mk
...
clean: clean-usb-2d-framework-2f-tinyusb-2f-src-2f-class-2f-audio

clean-usb-2d-framework-2f-tinyusb-2f-src-2f-class-2f-audio:
	-$(RM) ./usb-framework/tinyusb/src/class/audio/audio_device.cyclo ./usb-framework/tinyusb/src/class/audio/audio_device.d ./usb-framework/tinyusb/src/class/audio/audio_device.o ./usb-framework/tinyusb/src/class/audio/audio_device.su

.PHONY: clean-usb-2d-framework-2f-tinyusb-2f-src-2f-class-2f-audio
