...
C_SRCS += \
../usb-framework/tinyusb/src/class/bth/bth_device.c 

OBJS += \
./usb-framework/tinyusb/src/class/bth/bth_device.o 

C_DEPS += \
./usb-framework/tinyusb/src/class/bth/bth_device.d 


# Each subdirectory must supply rules for building sources it contributes
usb-framework/tinyusb/src/class/bth/%.o usb-framework/tinyusb/src/class/bth/%.su usb-framework/tinyusb/src/class/bth/%.cyclo: ../usb-framework/tinyusb/src/class/bth/%.c usb-framework/tinyusb/src/class/bth/subdir.mk
...
clean: clean-usb-2d-framework-2f-tinyusb-2f-src-2f-class-2f-bth

clean-usb-2d-framework-2f-tinyusb-2f-src-2f-class-2f-bth:
	-$(RM) ./usb-framework/tinyusb/src/class/bth/bth_device.cyclo ./usb-framework/tinyusb/src/class/bth/bth_device.d ./usb-framework/tinyusb/src/class/bth/bth_device.o ./usb-framework/tinyusb/src/class/bth/bth_device.su

.PHONY: clean-usb-2d-framework-2f-tinyusb-2f-src-2f-class-2f-bth
