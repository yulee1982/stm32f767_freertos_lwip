...
C_SRCS += \
../usb-framework/tinyusb/src/class/video/video_device.c 

OBJS += \
./usb-framework/tinyusb/src/class/video/video_device.o 

C_DEPS += \
./usb-framework/tinyusb/src/class/video/video_device.d 


# Each subdirectory must supply rules for building sources it contributes
usb-framework/tinyusb/src/class/video/%.o usb-framework/tinyusb/src/class/video/%.su usb-framework/tinyusb/src/class/video/%.cyclo: ../usb-framework/tinyusb/src/class/video/%.c usb-framework/tinyusb/src/class/video/subdir.mk
...
clean: clean-usb-2d-framework-2f-tinyusb-2f-src-2f-class-2f-video

clean-usb-2d-framework-2f-tinyusb-2f-src-2f-class-2f-video:
	-$(RM) ./usb-framework/tinyusb/src/class/video/video_device.cyclo ./usb-framework/tinyusb/src/class/video/video_device.d ./usb-framework/tinyusb/src/class/video/video_device.o ./usb-framework/tinyusb/src/class/video/video_device.su

.PHONY: clean-usb-2d-framework-2f-tinyusb-2f-src-2f-class-2f-video
