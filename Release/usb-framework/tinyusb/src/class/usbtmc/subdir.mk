...
C_SRCS += \
../usb-framework/tinyusb/src/class/usbtmc/usbtmc_device.c 

OBJS += \
./usb-framework/tinyusb/src/class/usbtmc/usbtmc_device.o 

C_DEPS += \
./usb-framework/tinyusb/src/class/usbtmc/usbtmc_device.d 


# Each subdirectory must supply rules for building sources it contributes
usb-framework/tinyusb/src/class/usbtmc/%.o usb-framework/tinyusb/src/class/usbtmc/%.su usb-framework/tinyusb/src/class/usbtmc/%.cyclo: ../usb-framework/tinyusb/src/class/usbtmc/%.c usb-framework/tinyusb/src/class/usbtmc/subdir.mk
...
clean: clean-usb-2d-framework-2f-tinyusb-2f-src-2f-class-2f-usbtmc

clean-usb-2d-framework-2f-tinyusb-2f-src-2f-class-2f-usbtmc:
	-$(RM) ./usb-framework/tinyusb/src/class/usbtmc/usbtmc_device.cyclo ./usb-framework/tinyusb/src/class/usbtmc/usbtmc_device.d ./usb-framework/tinyusb/src/class/usbtmc/usbtmc_device.o ./usb-framework/tinyusb/src/class/usbtmc/usbtmc_device.su

.PHONY: clean-usb-2d-framework-2f-tinyusb-2f-src-2f-class-2f-usbtmc
