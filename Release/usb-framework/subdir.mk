...
C_SRCS += \
../usb-framework/usb_app.c 

OBJS += \
./usb-framework/usb_app.o 

C_DEPS += \
./usb-framework/usb_app.d 


# Each subdirectory must supply rules for building sources it contributes
usb-framework/%.o usb-framework/%.su usb-framework/%.cyclo: ../usb-framework/%.c usb-framework/subdir.mk
...
clean: clean-usb-2d-framework

clean-usb-2d-framework:
	-$(RM) ./usb-framework/usb_app.cyclo ./usb-framework/usb_app.d ./usb-framework/usb_app.o ./usb-framework/usb_app.su

.PHONY: clean-usb-2d-framework
