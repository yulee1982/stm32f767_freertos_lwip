...
C_SRCS += \
../usb-framework/class/hid/usbd_hid.c \
../usb-framework/class/hid/usbh_hid.c 

OBJS += \
./usb-framework/class/hid/usbd_hid.o \
./usb-framework/class/hid/usbh_hid.o 

C_DEPS += \
./usb-framework/class/hid/usbd_hid.d \
./usb-framework/class/hid/usbh_hid.d 


# Each subdirectory must supply rules for building sources it contributes
usb-framework/class/hid/%.o usb-framework/class/hid/%.su usb-framework/class/hid/%.cyclo: ../usb-framework/class/hid/%.c usb-framework/class/hid/subdir.mk
...
clean: clean-usb-2d-framework-2f-class-2f-hid

clean-usb-2d-framework-2f-class-2f-hid:
	-$(RM) ./usb-framework/class/hid/usbd_hid.cyclo ./usb-framework/class/hid/usbd_hid.d ./usb-framework/class/hid/usbd_hid.o ./usb-framework/class/hid/usbd_hid.su ./usb-framework/class/hid/usbh_hid.cyclo ./usb-framework/class/hid/usbh_hid.d ./usb-framework/class/hid/usbh_hid.o ./usb-framework/class/hid/usbh_hid.su

.PHONY: clean-usb-2d-framework-2f-class-2f-hid
