...
C_SRCS += \
../usb-framework/class/video/usbd_video.c \
../usb-framework/class/video/usbh_video.c 

OBJS += \
./usb-framework/class/video/usbd_video.o \
./usb-framework/class/video/usbh_video.o 

C_DEPS += \
./usb-framework/class/video/usbd_video.d \
./usb-framework/class/video/usbh_video.d 


# Each subdirectory must supply rules for building sources it contributes
usb-framework/class/video/%.o usb-framework/class/video/%.su usb-framework/class/video/%.cyclo: ../usb-framework/class/video/%.c usb-framework/class/video/subdir.mk
...
clean: clean-usb-2d-framework-2f-class-2f-video

clean-usb-2d-framework-2f-class-2f-video:
	-$(RM) ./usb-framework/class/video/usbd_video.cyclo ./usb-framework/class/video/usbd_video.d ./usb-framework/class/video/usbd_video.o ./usb-framework/class/video/usbd_video.su ./usb-framework/class/video/usbh_video.cyclo ./usb-framework/class/video/usbh_video.d ./usb-framework/class/video/usbh_video.o ./usb-framework/class/video/usbh_video.su

.PHONY: clean-usb-2d-framework-2f-class-2f-video
