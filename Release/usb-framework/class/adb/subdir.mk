...
C_SRCS += \
../usb-framework/class/adb/usbd_adb.c 

OBJS += \
./usb-framework/class/adb/usbd_adb.o 

C_DEPS += \
./usb-framework/class/adb/usbd_adb.d 


# Each subdirectory must supply rules for building sources it contributes
usb-framework/class/adb/%.o usb-framework/class/adb/%.su usb-framework/class/adb/%.cyclo: ../usb-framework/class/adb/%.c usb-framework/class/adb/subdir.mk
...
clean: clean-usb-2d-framework-2f-class-2f-adb

clean-usb-2d-framework-2f-class-2f-adb:
	-$(RM) ./usb-framework/class/adb/usbd_adb.cyclo ./usb-framework/class/adb/usbd_adb.d ./usb-framework/class/adb/usbd_adb.o ./usb-framework/class/adb/usbd_adb.su

.PHONY: clean-usb-2d-framework-2f-class-2f-adb
