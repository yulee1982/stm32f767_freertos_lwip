...
C_SRCS += \
../usb-framework/class/audio/usbd_audio.c \
../usb-framework/class/audio/usbh_audio.c 

OBJS += \
./usb-framework/class/audio/usbd_audio.o \
./usb-framework/class/audio/usbh_audio.o 

C_DEPS += \
./usb-framework/class/audio/usbd_audio.d \
./usb-framework/class/audio/usbh_audio.d 


# Each subdirectory must supply rules for building sources it contributes
usb-framework/class/audio/%.o usb-framework/class/audio/%.su usb-framework/class/audio/%.cyclo: ../usb-framework/class/audio/%.c usb-framework/class/audio/subdir.mk
...
clean: clean-usb-2d-framework-2f-class-2f-audio

clean-usb-2d-framework-2f-class-2f-audio:
	-$(RM) ./usb-framework/class/audio/usbd_audio.cyclo ./usb-framework/class/audio/usbd_audio.d ./usb-framework/class/audio/usbd_audio.o ./usb-framework/class/audio/usbd_audio.su ./usb-framework/class/audio/usbh_audio.cyclo ./usb-framework/class/audio/usbh_audio.d ./usb-framework/class/audio/usbh_audio.o ./usb-framework/class/audio/usbh_audio.su

.PHONY: clean-usb-2d-framework-2f-class-2f-audio
