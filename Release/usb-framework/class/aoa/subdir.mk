...
C_SRCS += \
../usb-framework/class/aoa/usbh_aoa.c 

OBJS += \
./usb-framework/class/aoa/usbh_aoa.o 

C_DEPS += \
./usb-framework/class/aoa/usbh_aoa.d 


# Each subdirectory must supply rules for building sources it contributes
usb-framework/class/aoa/%.o usb-framework/class/aoa/%.su usb-framework/class/aoa/%.cyclo: ../usb-framework/class/aoa/%.c usb-framework/class/aoa/subdir.mk
...
clean: clean-usb-2d-framework-2f-class-2f-aoa

clean-usb-2d-framework-2f-class-2f-aoa:
	-$(RM) ./usb-framework/class/aoa/usbh_aoa.cyclo ./usb-framework/class/aoa/usbh_aoa.d ./usb-framework/class/aoa/usbh_aoa.o ./usb-framework/class/aoa/usbh_aoa.su

.PHONY: clean-usb-2d-framework-2f-class-2f-aoa
