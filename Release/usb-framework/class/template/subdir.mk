...
C_SRCS += \
../usb-framework/class/template/usbd_xxx.c \
../usb-framework/class/template/usbh_xxx.c 

OBJS += \
./usb-framework/class/template/usbd_xxx.o \
./usb-framework/class/template/usbh_xxx.o 

C_DEPS += \
./usb-framework/class/template/usbd_xxx.d \
./usb-framework/class/template/usbh_xxx.d 


# Each subdirectory must supply rules for building sources it contributes
usb-framework/class/template/%.o usb-framework/class/template/%.su usb-framework/class/template/%.cyclo: ../usb-framework/class/template/%.c usb-framework/class/template/subdir.mk
...
clean: clean-usb-2d-framework-2f-class-2f-template

clean-usb-2d-framework-2f-class-2f-template:
	-$(RM) ./usb-framework/class/template/usbd_xxx.cyclo ./usb-framework/class/template/usbd_xxx.d ./usb-framework/class/template/usbd_xxx.o ./usb-framework/class/template/usbd_xxx.su ./usb-framework/class/template/usbh_xxx.cyclo ./usb-framework/class/template/usbh_xxx.d ./usb-framework/class/template/usbh_xxx.o ./usb-framework/class/template/usbh_xxx.su

.PHONY: clean-usb-2d-framework-2f-class-2f-template
