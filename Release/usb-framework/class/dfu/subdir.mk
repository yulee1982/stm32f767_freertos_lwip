...
C_SRCS += \
../usb-framework/class/dfu/usbd_dfu.c 

OBJS += \
./usb-framework/class/dfu/usbd_dfu.o 

C_DEPS += \
./usb-framework/class/dfu/usbd_dfu.d 


# Each subdirectory must supply rules for building sources it contributes
usb-framework/class/dfu/%.o usb-framework/class/dfu/%.su usb-framework/class/dfu/%.cyclo: ../usb-framework/class/dfu/%.c usb-framework/class/dfu/subdir.mk
...
clean: clean-usb-2d-framework-2f-class-2f-dfu

clean-usb-2d-framework-2f-class-2f-dfu:
	-$(RM) ./usb-framework/class/dfu/usbd_dfu.cyclo ./usb-framework/class/dfu/usbd_dfu.d ./usb-framework/class/dfu/usbd_dfu.o ./usb-framework/class/dfu/usbd_dfu.su

.PHONY: clean-usb-2d-framework-2f-class-2f-dfu
