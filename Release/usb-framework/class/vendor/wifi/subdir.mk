...
C_SRCS += \
../usb-framework/class/vendor/wifi/usbh_bl616.c 

OBJS += \
./usb-framework/class/vendor/wifi/usbh_bl616.o 

C_DEPS += \
./usb-framework/class/vendor/wifi/usbh_bl616.d 


# Each subdirectory must supply rules for building sources it contributes
usb-framework/class/vendor/wifi/%.o usb-framework/class/vendor/wifi/%.su usb-framework/class/vendor/wifi/%.cyclo: ../usb-framework/class/vendor/wifi/%.c usb-framework/class/vendor/wifi/subdir.mk
...
clean: clean-usb-2d-framework-2f-class-2f-vendor-2f-wifi

clean-usb-2d-framework-2f-class-2f-vendor-2f-wifi:
	-$(RM) ./usb-framework/class/vendor/wifi/usbh_bl616.cyclo ./usb-framework/class/vendor/wifi/usbh_bl616.d ./usb-framework/class/vendor/wifi/usbh_bl616.o ./usb-framework/class/vendor/wifi/usbh_bl616.su

.PHONY: clean-usb-2d-framework-2f-class-2f-vendor-2f-wifi
