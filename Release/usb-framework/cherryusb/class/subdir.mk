...
C_SRCS += \
../usb-framework/cherryusb/class/usbd_hid.c \
../usb-framework/cherryusb/class/usbh_hid.c 

OBJS += \
./usb-framework/cherryusb/class/usbd_hid.o \
./usb-framework/cherryusb/class/usbh_hid.o 

C_DEPS += \
./usb-framework/cherryusb/class/usbd_hid.d \
./usb-framework/cherryusb/class/usbh_hid.d 


# Each subdirectory must supply rules for building sources it contributes
usb-framework/cherryusb/class/%.o usb-framework/cherryusb/class/%.su usb-framework/cherryusb/class/%.cyclo: ../usb-framework/cherryusb/class/%.c usb-framework/cherryusb/class/subdir.mk
...
clean: clean-usb-2d-framework-2f-cherryusb-2f-class

clean-usb-2d-framework-2f-cherryusb-2f-class:
	-$(RM) ./usb-framework/cherryusb/class/usbd_hid.cyclo ./usb-framework/cherryusb/class/usbd_hid.d ./usb-framework/cherryusb/class/usbd_hid.o ./usb-framework/cherryusb/class/usbd_hid.su ./usb-framework/cherryusb/class/usbh_hid.cyclo ./usb-framework/cherryusb/class/usbh_hid.d ./usb-framework/cherryusb/class/usbh_hid.o ./usb-framework/cherryusb/class/usbh_hid.su

.PHONY: clean-usb-2d-framework-2f-cherryusb-2f-class
