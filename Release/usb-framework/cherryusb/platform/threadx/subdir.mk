...
C_SRCS += \
../usb-framework/cherryusb/platform/threadx/usbh_msc_filex.c 

OBJS += \
./usb-framework/cherryusb/platform/threadx/usbh_msc_filex.o 

C_DEPS += \
./usb-framework/cherryusb/platform/threadx/usbh_msc_filex.d 


# Each subdirectory must supply rules for building sources it contributes
usb-framework/cherryusb/platform/threadx/%.o usb-framework/cherryusb/platform/threadx/%.su usb-framework/cherryusb/platform/threadx/%.cyclo: ../usb-framework/cherryusb/platform/threadx/%.c usb-framework/cherryusb/platform/threadx/subdir.mk
...
clean: clean-usb-2d-framework-2f-cherryusb-2f-platform-2f-threadx

clean-usb-2d-framework-2f-cherryusb-2f-platform-2f-threadx:
	-$(RM) ./usb-framework/cherryusb/platform/threadx/usbh_msc_filex.cyclo ./usb-framework/cherryusb/platform/threadx/usbh_msc_filex.d ./usb-framework/cherryusb/platform/threadx/usbh_msc_filex.o ./usb-framework/cherryusb/platform/threadx/usbh_msc_filex.su

.PHONY: clean-usb-2d-framework-2f-cherryusb-2f-platform-2f-threadx
