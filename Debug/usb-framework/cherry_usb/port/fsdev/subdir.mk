...
C_SRCS += \
../usb-framework/cherry_usb/port/fsdev/usb_dc_fsdev.c \
../usb-framework/cherry_usb/port/fsdev/usb_glue_st.c 

OBJS += \
./usb-framework/cherry_usb/port/fsdev/usb_dc_fsdev.o \
./usb-framework/cherry_usb/port/fsdev/usb_glue_st.o 

C_DEPS += \
./usb-framework/cherry_usb/port/fsdev/usb_dc_fsdev.d \
./usb-framework/cherry_usb/port/fsdev/usb_glue_st.d 


# Each subdirectory must supply rules for building sources it contributes
usb-framework/cherry_usb/port/fsdev/%.o usb-framework/cherry_usb/port/fsdev/%.su usb-framework/cherry_usb/port/fsdev/%.cyclo: ../usb-framework/cherry_usb/port/fsdev/%.c usb-framework/cherry_usb/port/fsdev/subdir.mk
...
clean: clean-usb-2d-framework-2f-cherry_usb-2f-port-2f-fsdev

clean-usb-2d-framework-2f-cherry_usb-2f-port-2f-fsdev:
	-$(RM) ./usb-framework/cherry_usb/port/fsdev/usb_dc_fsdev.cyclo ./usb-framework/cherry_usb/port/fsdev/usb_dc_fsdev.d ./usb-framework/cherry_usb/port/fsdev/usb_dc_fsdev.o ./usb-framework/cherry_usb/port/fsdev/usb_dc_fsdev.su ./usb-framework/cherry_usb/port/fsdev/usb_glue_st.cyclo ./usb-framework/cherry_usb/port/fsdev/usb_glue_st.d ./usb-framework/cherry_usb/port/fsdev/usb_glue_st.o ./usb-framework/cherry_usb/port/fsdev/usb_glue_st.su

.PHONY: clean-usb-2d-framework-2f-cherry_usb-2f-port-2f-fsdev
