...
C_SRCS += \
../usb-framework/simple_usb/class/adb/usbd_adb.c 

OBJS += \
./usb-framework/simple_usb/class/adb/usbd_adb.o 

C_DEPS += \
./usb-framework/simple_usb/class/adb/usbd_adb.d 


# Each subdirectory must supply rules for building sources it contributes
usb-framework/simple_usb/class/adb/%.o usb-framework/simple_usb/class/adb/%.su usb-framework/simple_usb/class/adb/%.cyclo: ../usb-framework/simple_usb/class/adb/%.c usb-framework/simple_usb/class/adb/subdir.mk
...
clean: clean-usb-2d-framework-2f-simple_usb-2f-class-2f-adb

clean-usb-2d-framework-2f-simple_usb-2f-class-2f-adb:
	-$(RM) ./usb-framework/simple_usb/class/adb/usbd_adb.cyclo ./usb-framework/simple_usb/class/adb/usbd_adb.d ./usb-framework/simple_usb/class/adb/usbd_adb.o ./usb-framework/simple_usb/class/adb/usbd_adb.su

.PHONY: clean-usb-2d-framework-2f-simple_usb-2f-class-2f-adb
