...
C_SRCS += \
../usb-framework/simple_usb/class/hub/usbh_hub.c 

OBJS += \
./usb-framework/simple_usb/class/hub/usbh_hub.o 

C_DEPS += \
./usb-framework/simple_usb/class/hub/usbh_hub.d 


# Each subdirectory must supply rules for building sources it contributes
usb-framework/simple_usb/class/hub/%.o usb-framework/simple_usb/class/hub/%.su usb-framework/simple_usb/class/hub/%.cyclo: ../usb-framework/simple_usb/class/hub/%.c usb-framework/simple_usb/class/hub/subdir.mk
...
clean: clean-usb-2d-framework-2f-simple_usb-2f-class-2f-hub

clean-usb-2d-framework-2f-simple_usb-2f-class-2f-hub:
	-$(RM) ./usb-framework/simple_usb/class/hub/usbh_hub.cyclo ./usb-framework/simple_usb/class/hub/usbh_hub.d ./usb-framework/simple_usb/class/hub/usbh_hub.o ./usb-framework/simple_usb/class/hub/usbh_hub.su

.PHONY: clean-usb-2d-framework-2f-simple_usb-2f-class-2f-hub
