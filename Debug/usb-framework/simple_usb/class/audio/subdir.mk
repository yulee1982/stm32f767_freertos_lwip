...
C_SRCS += \
../usb-framework/simple_usb/class/audio/usbd_audio.c \
../usb-framework/simple_usb/class/audio/usbh_audio.c 

OBJS += \
./usb-framework/simple_usb/class/audio/usbd_audio.o \
./usb-framework/simple_usb/class/audio/usbh_audio.o 

C_DEPS += \
./usb-framework/simple_usb/class/audio/usbd_audio.d \
./usb-framework/simple_usb/class/audio/usbh_audio.d 


# Each subdirectory must supply rules for building sources it contributes
usb-framework/simple_usb/class/audio/%.o usb-framework/simple_usb/class/audio/%.su usb-framework/simple_usb/class/audio/%.cyclo: ../usb-framework/simple_usb/class/audio/%.c usb-framework/simple_usb/class/audio/subdir.mk
...
clean: clean-usb-2d-framework-2f-simple_usb-2f-class-2f-audio

clean-usb-2d-framework-2f-simple_usb-2f-class-2f-audio:
	-$(RM) ./usb-framework/simple_usb/class/audio/usbd_audio.cyclo ./usb-framework/simple_usb/class/audio/usbd_audio.d ./usb-framework/simple_usb/class/audio/usbd_audio.o ./usb-framework/simple_usb/class/audio/usbd_audio.su ./usb-framework/simple_usb/class/audio/usbh_audio.cyclo ./usb-framework/simple_usb/class/audio/usbh_audio.d ./usb-framework/simple_usb/class/audio/usbh_audio.o ./usb-framework/simple_usb/class/audio/usbh_audio.su

.PHONY: clean-usb-2d-framework-2f-simple_usb-2f-class-2f-audio
