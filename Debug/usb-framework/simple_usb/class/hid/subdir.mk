...
C_SRCS += \
../usb-framework/simple_usb/class/hid/usbd_hid.c \
../usb-framework/simple_usb/class/hid/usbh_hid.c 

OBJS += \
./usb-framework/simple_usb/class/hid/usbd_hid.o \
./usb-framework/simple_usb/class/hid/usbh_hid.o 

C_DEPS += \
./usb-framework/simple_usb/class/hid/usbd_hid.d \
./usb-framework/simple_usb/class/hid/usbh_hid.d 


# Each subdirectory must supply rules for building sources it contributes
usb-framework/simple_usb/class/hid/%.o usb-framework/simple_usb/class/hid/%.su usb-framework/simple_usb/class/hid/%.cyclo: ../usb-framework/simple_usb/class/hid/%.c usb-framework/simple_usb/class/hid/subdir.mk
...
clean: clean-usb-2d-framework-2f-simple_usb-2f-class-2f-hid

clean-usb-2d-framework-2f-simple_usb-2f-class-2f-hid:
	-$(RM) ./usb-framework/simple_usb/class/hid/usbd_hid.cyclo ./usb-framework/simple_usb/class/hid/usbd_hid.d ./usb-framework/simple_usb/class/hid/usbd_hid.o ./usb-framework/simple_usb/class/hid/usbd_hid.su ./usb-framework/simple_usb/class/hid/usbh_hid.cyclo ./usb-framework/simple_usb/class/hid/usbh_hid.d ./usb-framework/simple_usb/class/hid/usbh_hid.o ./usb-framework/simple_usb/class/hid/usbh_hid.su

.PHONY: clean-usb-2d-framework-2f-simple_usb-2f-class-2f-hid
